...
enum RouteName { home, aboutMe, experience, education, notFound }

extension RouteNameExt on RouteName {
  static List<RouteName> pages = [RouteName.aboutMe, RouteName.experience, RouteName.education];
  ...
  String? title(BuildContext context) => switch (this) {
    ...
    RouteName.experience => AppLocalizations.of(context)?.experienceview_title,
    RouteName.education => AppLocalizations.of(context)?.educationview_title,
