...
class PortfolioAppTheming {
  ...
  static const minButtonSize = Size(Dimens.minButtonWidth, Dimens.minButtonHeight);
  ...
  static ElevatedButtonThemeData _elevatedButtonThemeData({required bool isDark}) => ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      foregroundColor: WidgetStatePropertyAll(isDark ? Colors.black : Colors.white),
  ...
  static CardThemeData _cardTheme({required bool isDark}) => CardThemeData(
    ...
    shape: RoundedRectangleBorder(
      ...
      side: BorderSide(color: isDark ? Colors.white : Colors.black, width: Dimens.one),
    ),
  );
