...
final simonePioCaronia = Me(
  ...
  about: About(
    cvUrl: Res.pdfSpcCv,
    intro: (l10n, params) => l10n.aboutme_intro(params['firstName'], params['yearsOld']),
    technologies: [
      ...
      Technology(icon: SimpleIcons.nodedotjs, name: 'Node.js'),
      Technology(icon: SimpleIcons.docker, name: 'Docker'),
      Technology(icon: SimpleIcons.firebase, name: 'Firebase'),
      Technology(icon: SimpleIcons.databricks, name: 'SQL'),
    ],
    softSkills: [
      SoftSkill(emoji: '✅', label: (l10n) => l10n.aboutme_softskills_problemsolving),
      SoftSkill(emoji: '👥', label: (l10n) => l10n.aboutme_softskills_teamworking),
      SoftSkill(emoji: '🗣️', label: (l10n) => l10n.aboutme_softskills_publicspeaking),
      SoftSkill(emoji: '📌', label: (l10n) => l10n.aboutme_softskills_determination),
      SoftSkill(emoji: '🎨', label: (l10n) => l10n.aboutme_softskills_creativity),
    ],
    hobbies: [
      Hobby(label: (l10n) => l10n.aboutme_hobbies_racket, imageUrl: Res.jpgHobbyRacket),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_basketball, imageUrl: Res.jpgHobbyBasket),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_gdmi, imageUrl: Res.jpgHobbyGdmi),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_sea, imageUrl: Res.jpgHobbySea),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_trumpet, imageUrl: Res.jpgHobbyTrumpet),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_travelling, imageUrl: Res.jpgHobbyTravelling),
      Hobby(label: (l10n) => l10n.aboutme_hobbies_lego, imageUrl: Res.jpgHobbyLego),
    ],
    projects: [
      Project(
        title: 'portfolio',
        description: (l10n) => l10n.aboutme_projects_portfolio_description,
        links: [(label: null, url: 'https://github.com/spioc999/portfolio')],
        techIcons: [SimpleIcons.flutter, SimpleIcons.dart, SimpleIcons.githubactions],
        hashtags: ['web'],
      ),
      Project(
        title: 'federated-learning-thesis',
        description: (l10n) => l10n.aboutme_projects_federatedlearning_description,
        links: [
          (
            label: (l10n) => l10n.aboutme_projects_federatedlearning_pythonlink_label,
            url: 'https://github.com/spioc999/federated-learning-thesis-project',
          ),
          (
            label: (l10n) => l10n.aboutme_projects_federatedlearning_nodejslink_label,
            url: 'https://github.com/spioc999/federated-learning-module-snark-js',
          ),
        ],
        techIcons: [SimpleIcons.python, SimpleIcons.nodedotjs],
      ...
      Project(
        ...
        links: [
          ...
          (label: (l10n) => l10n.aboutme_projects_bingo_felink_label, url: 'https://github.com/spioc999/bingo_fe'),
        ],
        techIcons: [SimpleIcons.flutter, SimpleIcons.dart, SimpleIcons.python, SimpleIcons.docker],
        hashtags: ['api', 'socket'],
      ),
    ],
    certifications: [
  ...
  experiences: [
    ...
    Experience(
      ...
      company: 'NTT Data',
      companyUrl: 'https://it.nttdata.com/',
      description: (l10n) => l10n.experience_nttdata_intership_mobile_description,
      companyImageUrl: Res.jpgExperienceNttdata,
      startDateTime: DateTime(2020, 4),
      endDateTime: DateTime(2020, 8),
